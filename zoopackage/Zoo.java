...
public class Zoo{
    ...
    public Zoo(int numDays){
        //Identity example regarding lines 10-31 (excluding 11) 
        //These are examples of object identity because each new animal object is given its own unique name identifier.
